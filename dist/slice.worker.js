...
var require_spark_md5 = __commonJS({
  "node_modules/.pnpm/spark-md5@3.0.2/node_modules/spark-md5/spark-md5.js"(exports2, module2) {
    (function(factory) {
      ...
      "use strict";
      var add32 = /* @__PURE__ */ __name(function(a, b) {
      ...
      if (hex(md51("hello")) !== "5d41402abc4b2a76b9719d911017c592") {
        add32 = /* @__PURE__ */ __name(function(x, y) {
      ...
      __name(utf8Str2ArrayBuffer, "utf8Str2ArrayBuffer");
      function arrayBuffer2Utf8Str(buff) {
        return String.fromCharCode.apply(null, new Uint8Array(buff));
      }
      __name(arrayBuffer2Utf8Str, "arrayBuffer2Utf8Str");
      ...
      __name(hexToBinaryString, "hexToBinaryString");
      function SparkMD52() {
        this.reset();
      }
      __name(SparkMD52, "SparkMD5");
...
// src/slice.worker.ts
var slice_worker_exports = {};
__export(slice_worker_exports, {
  createChunk: () => createChunk
});
module.exports = __toCommonJS(slice_worker_exports);
...
function onMessage(e) {
  return __async(this, null, function* () {
    ...
    const chunks = yield Promise.all(proms);
    postMessage(chunks);
  });
}
